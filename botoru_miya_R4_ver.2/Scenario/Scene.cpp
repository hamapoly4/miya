...
//		case 81:
		...
		case 10:
			...
			break;
		case 24:
			mJudgeMent[mcurrent_scene_no] = new RotateAngleJudgeMent(LEFT, -130);	//RotateL
			break;
		case 28:
			mJudgeMent[mcurrent_scene_no] = new RotateAngleJudgeMent(LEFT, -80);	//RotateL
			break;
		...
		case 43:
		case 50:
			mJudgeMent[mcurrent_scene_no] = new RotateAngleJudgeMent(RIGHT, 45);	//RotateR
			break;
		case 17:
			mJudgeMent[mcurrent_scene_no] = new RotateAngleJudgeMent(RIGHT, 178);	//RotateR
			break;
		case 32:
		case 39:
			mJudgeMent[mcurrent_scene_no] = new RotateAngleJudgeMent(RIGHT, 130);	//RotateR
			break;
