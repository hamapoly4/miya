	...
	: mcurrent_scene_no(scene_no)
{
	...
	switch (mcurrent_scene_no)
	{
		...
		case 2:
			mJudgeMent[mcurrent_scene_no] = new RunDistJudgeMent(BOTH, 190);	//straPush
			break;
		case 12:
		case 18:
		case 28:
		...
		case 53:
		case 59:
			mJudgeMent[mcurrent_scene_no] = new RunDistJudgeMent(LEFT, 210);	//LineTraceL
			break;
		...
		case 47:
		case 65:
			mJudgeMent[mcurrent_scene_no] = new RunDistJudgeMent(RIGHT, 210);	//LineTraceR
			break;
