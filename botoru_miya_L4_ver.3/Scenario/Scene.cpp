	...
	: mcurrent_scene_no(scene_no)
{
	...
	switch (mcurrent_scene_no)
	{
		...
		case 10:
			...
			break;
		case 24:
			mJudgeMent[mcurrent_scene_no] = new RotateAngleJudgeMent(RIGHT, 118);	//RotateR
			break;
		case 28:
			mJudgeMent[mcurrent_scene_no] = new RotateAngleJudgeMent(RIGHT, 77);	//RotateR
			break;
		...
		case 50:
			...
			break;
		case 17:
			mJudgeMent[mcurrent_scene_no] = new RotateAngleJudgeMent(LEFT, -176);	//RotateL
			break;
		case 32:
		case 39:
